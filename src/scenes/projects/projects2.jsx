...
import BoxImg from "../../components/projects2/boxImg";
  ...
  return (
    ...
    >
      ...
      <BoxTitle
        number="02"
        title="Jewel"
        subtitle="The designed website is a WordPress template that is suitable for businesses that operate in the field of jewelry."
      ...
      >
        ...
        <Box position="absolute" left="140px" component="a" href="/contact">
